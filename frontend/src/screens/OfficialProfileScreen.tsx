...
const OfficialProfileScreen = () => {
  ...
  const [modalType, setModalType] = useState<"NONE" | "INFO" | "PASSWORD">("NONE");
            ...
            <Modal visible={modalType === "INFO"} transparent animationType="fade">
              <View style={styles.passwordModalOverlay}>
                <View style={styles.passwordModalContainer}>
                  ...
                  <Text style={{fontSize: 12, color: '#666', marginBottom: 5, marginLeft: 2}}>Ad Soyad</Text>
                  <TextInput 
                  ...
                  <Text style={{fontSize: 12, color: '#666', marginBottom: 5, marginLeft: 2, marginTop: 10}}>Telefon</Text>
                  <TextInput 
                    style={styles.passwordInput} 
                    placeholder="Telefon" 
                    placeholderTextColor="#999" 
